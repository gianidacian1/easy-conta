...
class BalantaController extends Controller
{
  public function index(Request $request)
  {
    $query = Balanta::where('user_id', auth()->user()->id);
    ...
    $balante = $query->paginate($request->get('per_page', 25))
      ->withQueryString(); // Preserve query parameters

    return Inertia::render('balante/Index', [
      'balante' => $balante,
  ...
  public function upload(Request $request)
  {
    ...
    $file = $request->file('balanta'); // single file
